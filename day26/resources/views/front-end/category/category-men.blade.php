                            ...
                            <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
                                <ul>
                                    <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                        <ul>
                                            <li><a href="{{ route('category-product2') }}">Shirts</a></li>
                                            <li><a href="{{ route('category-product2') }}">Caps</a></li>
                                            <li><a href="{{ route('category-product2') }}">Shoes</a></li>
                                            <li><a href="{{ route('category-product2') }}">Pants</a></li>
                                            <li><a href="{{ route('category-product2') }}">SunGlasses</a></li>
                                            <li><a href="{{ route('category-product2') }}">Trousers</a></li>
                                        </ul>
                                    </li>
