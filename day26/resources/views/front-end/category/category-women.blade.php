                                ...
                                <li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
                                    <ul>
                                        <li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
                                            <ul>
                                                <li><a href="{{ route('category-product1') }}">Shirts</a></li>
                                                <li><a href="{{ route('category-product1') }}">Caps</a></li>
                                                <li><a href="{{ route('category-product1') }}">Shoes</a></li>
                                                <li><a href="{{ route('category-product1') }}">Pants</a></li>
                                                <li><a href="{{ route('category-product1') }}">SunGlasses</a></li>
                                                <li><a href="{{ route('category-product1') }}">Trousers</a></li>
                                            </ul>
                                        </li>
