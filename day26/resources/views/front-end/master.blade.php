                                        ...
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{ route('category-product1') }}">Clothing</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Wallets</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Shoes</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu2</h6>
                                                    <li><a href="{{ route('category-product1') }}">Sunglasses</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Wallets,Bags</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Footwear</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Accessories</a></li>
                                                    <li><a href="{{ route('category-product1') }}">Jewellery</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product1') }}"><img src="{{asset('/')}}/front-end/images/woo.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product1') }}"><img src="{{asset('/')}}/front-end/images/woo1.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
                                    ...
                                    <ul class="dropdown-menu multi-column columns-3">
                                        <div class="row">
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu1</h6>
                                                    <li><a href="{{ route('category-product2') }}">Clothing</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Wallets</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Shoes</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Accessories</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <ul class="multi-column-dropdown">
                                                    <h6>Submenu2</h6>
                                                    <li><a href="{{ route('category-product2') }}">Sunglasses</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Wallets,Bags</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Footwear</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Watches</a></li>
                                                    <li><a href="{{ route('category-product2') }}">Accessories</a></li>
                                            ...
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product2') }}"><img src="{{asset('/')}}/front-end/images/woo3.jpg" alt=" "/></a>
                                            </div>
                                            <div class="col-sm-3  multi-gd-img">
                                                <a href="{{ route('category-product2') }}"><img src="{{asset('/')}}/front-end/images/woo4.jpg" alt=" "/></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </ul>
        ...
        <div class="footer-grids">
            ...
            <div class="col-md-3 footer-grid">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('category-product1') }}">Women's Wear</a></li>
                    <li><a href="{{route('short-codes')}}">Short Codes</a></li>
                    <li><a href="{{ route('mail') }}">Mail Us</a></li>
                    <li><a href="{{ route('category-product2') }}">Men's Wear</a></li>
                </ul>
            </div>
